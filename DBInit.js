...
async function initializeSong(connection, authors, genres) {
  const songs = [];
  const songName = ['Dancing With A Stranger', 'bad guy', 'I Don\'t Care', 'ME!', 'Please Me', 'Nothing Breaks Like a Heart', 'If I Can\'t have You', 'MIDDLE CHILD', 'Here with Me', 'Easier'];
  for (let i = 0; i <= 9; i += 1) {
