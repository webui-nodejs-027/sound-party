...
const { baseValidator, genreValidator: authorValidator } = require('../validators/Validators.js');
...
router.post('/', authorValidator.checkBody, authorController.insertData.bind(authorController));
